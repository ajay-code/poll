...
$optionData = $admin->getOption($_GET['optionID']);
?>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" id="title" value="<?= $optionData['name']  ?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button role="submit" name="submit-option" class="btn btn-primary">Edit</button>
                                    </div>
                                </div>
                            </form>
                    </section>
